...
REQUIRED_PACKAGES = [
    ...
    'Cython',
    'librosa>=0.8.0',
    'numba==0.55.1', # Manually specified here as librosa incorrectly states that it is compatible with the latest version of numba although 0.50.0 is not compatible. 
    'scipy',
    'mido>=1.2.6',
    'pytest',
    #'pyaudio',
